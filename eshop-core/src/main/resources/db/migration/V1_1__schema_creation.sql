...
CREATE TABLE REQUEST_LOG (
	...
	CONSTRAINT CHK_REQUEST_LOG_DEVICE CHECK (DEVICE IN ('N', 'M', 'T', 'U'))
) ENGINE=INNODB;
...
CREATE TABLE PRODUCT_ARTICLE (
	...
	CONSTRAINT FK_PRODUCT_ARTICLE_IMG FOREIGN KEY (MAIN_IMAGE_KEY) REFERENCES FILE (FILE_KEY),
...
CREATE TABLE PRODUCT (
	...
	CONSTRAINT FK_PRODUCT_IMG FOREIGN KEY (MAIN_IMAGE_KEY) REFERENCES FILE (FILE_KEY)
) ENGINE=INNODB;
...
CREATE TABLE PRODUCT_ARTICLE_IMAGE (
    ...
    CONSTRAINT FK_IMG_PAO FOREIGN KEY (IMAGE_KEY) REFERENCES FILE (FILE_KEY)
) ENGINE=INNODB;
...
CREATE TABLE `ORDER` (
	...
	CONSTRAINT CHK_ORDER_STATUS CHECK (ORDER_STATUS IN ('N', 'P', 'A', 'S', 'D', 'C', 'R')),
