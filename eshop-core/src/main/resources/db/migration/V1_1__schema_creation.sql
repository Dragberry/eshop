...
CREATE TABLE PRODUCT (
	...
	CONSTRAINT CHK_SALE_STATUS CHECK (SALE_STATUS IN ('E', 'I', 'O'))
...
CREATE TABLE DELIVERY_METHOD (
	DELIVERY_METHOD_KEY BIGINT NOT NULL,
	NAME VARCHAR(64) NOT NULL,
	DESCRIPTION VARCHAR(256) NOT NULL,
	PRICE NUMERIC (10, 2),
	STATUS CHAR(1) NOT NULL,
	`ORDER` INT NOT NULL DEFAULT 0,
	VERSION BIGINT NOT NULL DEFAULT 0,
	PRIMARY KEY (DELIVERY_METHOD_KEY),
	CONSTRAINT CHK_DLV_METHOD_STATUS CHECK (ORDER_STATUS IN ('A', 'I'))
) ENGINE=INNODB;
...
CREATE TABLE `ORDER` (
	...
	CONSTRAINT CHK_ORDER_STATUS CHECK (ORDER_STATUS IN ('N', 'C', 'D')),
	CONSTRAINT FK_ORDER_PMT FOREIGN KEY (PAYMENT_METHOD_KEY) REFERENCES PAYMENT_METHOD (PAYMENT_METHOD_KEY),
    CONSTRAINT FK_ORDER_DLV FOREIGN KEY (DELIVERY_METHOD_KEY) REFERENCES DELIVERY_METHOD (DELIVERY_METHOD_KEY)
) ENGINE=INNODB;
